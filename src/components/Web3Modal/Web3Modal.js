         ...
         <Backdrop visible={visible} onClick={close}></Backdrop>
            <FormWrapper visible={visible}>
                ...
                <ButtonContainer>
                    ...
                    <Provider margin={"20px"} width1={50} logo={fortmatic} width2={27} title={"Fortmatic"}></Provider>
                    <Provider margin={"20px"} width1={50} logo={torus} width2={27} title={"Torus"}></Provider>
                    <Provider margin={"20px"} width1={50} logo={portis} width2={25} title={"Portis"}></Provider>
