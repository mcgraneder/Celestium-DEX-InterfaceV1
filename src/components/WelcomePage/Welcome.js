...
const WelcomePage = () => {
    ...
    return(
        <div>
            <div>
                <Wrapper space={50}/>
                <StyledTitle size={100} margin={0} weight={900} styleds={"italic"} align={"center"}>ALPHA-BAETRUM.</StyledTitle>
                <StyledTitle size={80} margin={20} weight={600} align={"center"}>Prepetuals Trading</StyledTitle>
